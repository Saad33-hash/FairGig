    ...
    <div className="min-h-screen flex flex-col bg-slate-100">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-10 max-w-md w-full text-center flex flex-col items-center gap-4">
          ...
          <h1 className="text-xl font-bold text-slate-900">Grievance Moderation</h1>
          <p className="text-sm text-slate-500 leading-relaxed">
            Tag, cluster, escalate, and resolve worker complaints from this panel. Coming in Phase 7.
          </p>
        </div>
      </div>
    </div>
